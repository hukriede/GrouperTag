/*
 * Initial firmware provided by SparkFun and modified to add global variables and serial characters to enable temperature/pressure logging.
 * 
...
#define ENABLE_SENSOR     'd' // Enable/disable pressure/temperature log
